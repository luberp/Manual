Wichtige Eckdaten für die Vertriebsverwaltung sind Ihre Vermittler. Sie erreichen die Maske durch einen Klick auf den Karteireiter *Vermittler*.
Reiter *Allgemein Adressen Eigenschaften Provisionssätze Struktur Buchung Ereignisse Belege Umsätze Auswertungen - Links, Google Maps*
...
Links wird gegebenenfalls eine Übersicht Ihrer bestehenden Vermittler angezeigt. Legen Sie neue Vermittler mit Menü	_Datei → Neu → Vermittler_ oder über die Schaltfläche  ![](http://xpecto.github.io/docs/img/img_1431437056167.png) an. Gehen Sie der Aufforderung, eine freie Vermittlernummer einzugeben, nach und bestätigen Sie mit OK. Evtl. wurde die Software bei der Installation so eingestellt, dass Vermittlernummern automatisch fortlaufend vergeben werden. In diesem Fall wird vom Programm die nächste freie Nummer vorgeschlagen. Ansonsten vergeben Sie nach Ihrer vertriebsinternen Richtlinie eine freie Nummer.
...
Auf den Karteireiter *Eigenschaften* werden zusätzliche Infos wie Adressherkunft oder Bemerkungen zum Vermittler festgehalten.
