...
Die Unterkarteireiter *Legitimationsdaten, Kirchensteuer, Auslands-Steuer* können kundenspezifische Daten beinhalten.
...
Auf dem Karteireiter *Ereignisse* werden wichtige Ereignisse zum aktuell ausgewählten Kunde sowie zugehörige Verträge festgehalten. 
Die Ereignisse können auf mehrere Ebenen verteilt werden: *Kundenebene, Beteiligungsebene, Pflicht-Dokument, Beschwerde.* 

![](http://xpecto.github.io/docs/img/img_1438076449296.png)


Beispiel: Sie haben einen Telefonat wegen einen Vertrag durchgeführt.
Wählen Sie dazu ![](http://xpecto.github.io/docs/img/img_1438331776248.png)
...
Nachdem die eingegebenen Daten mit OK bestätigt haben, wird die Liste der Ereignisse angezeigt.
